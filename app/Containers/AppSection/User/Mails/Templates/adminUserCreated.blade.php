                ...
                <td align="center" valign="center" style="text-align:center; padding-bottom: 10px">
                    <div style="margin:0 60px 34px 60px">
                        <div style="text-align:start; font-size: 13px; font-weight: 500; margin-bottom: 15px; font-family:Arial,Helvetica,sans-serif;">
                            ...
                            <p style="margin-top:0; margin-bottom:2px; color:#5E6278">Su cuenta de Administrador ha sido creada y habilitada para su acceso.</p>
                            <p style="margin-top:0; margin-bottom:2px; color:#5E6278">Panel administrativo de
                        ...
                        <div style="background: #F9F9F9; border-radius: 12px; padding:15px 30px">
                            ...
                            @if($user->roles->first()->name === 'childcare_admin' && $user->childcareCenter)
                            <p style="margin-top:0; margin-bottom:0px; color:#181C32; font-size: 16px; font-weight:700">Centro Asignado: {{ $user->childcareCenter->name }}</p>
                            @endif
                        </div>
                        <div style="text-align: center; margin-top: 20px;">
                            <a href="{{ $loginUrl }}" style="background-color: #007bff; color: white; padding: 12px 24px; text-decoration: none; border-radius: 6px; font-weight: 600; display: inline-block;">Acceder al Panel Administrativo</a>
                        </div>
                    </div>
                </td>
            <tr>
