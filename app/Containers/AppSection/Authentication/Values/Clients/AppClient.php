...
final readonly class AppClient extends ParentValue implements Client
{
    private const ID_CONFIG_KEY = 'appSection-authentication.clients.app.id';
    private const SECRET_CONFIG_KEY = 'appSection-authentication.clients.app.secret';
    ...
    public static function create(): self
    {
        ...
        Assert::true(
            ...
            'The app client id must be a non-empty string or an integer',
        );
        Assert::stringNotEmpty($plainSecret, 'The app client secret must be a non-empty string');
