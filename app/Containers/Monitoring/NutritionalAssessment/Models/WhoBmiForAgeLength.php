...
/**
 * Modelo para la tabla de referencia WHO: BMI for Age (usando Length).
 * 
 * Contiene los parámetros LMS y desviaciones estándar precalculadas
 * para calcular z-scores de IMC según edad y género.
 * Rango: 0-24 meses (0-2 años) - IMC usando longitud (medición acostado)
 */
final class WhoBmiForAgeLength extends ParentModel
{
    /**
     * Nombre de la tabla.
     */
    protected $table = 'who_bmi_for_age_length';
