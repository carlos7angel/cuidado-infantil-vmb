...
/**
 * Modelo para la tabla de referencia WHO: BMI for Age (usando Height).
 * 
 * Contiene los parámetros LMS y desviaciones estándar precalculadas
 * para calcular z-scores de IMC según edad y género.
 * Rango: 24-60 meses (2-5 años) - IMC usando talla (medición de pie)
 */
final class WhoBmiForAgeHeight extends ParentModel
{
    /**
     * Nombre de la tabla.
     */
    protected $table = 'who_bmi_for_age_height';
     ...
     * 
     * @param int $month Edad en meses (24-60)
     * @param int $gender 1 = Masculino, 2 = Femenino
     * @return self|null
     */
