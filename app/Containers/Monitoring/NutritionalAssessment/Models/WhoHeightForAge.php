...
/**
 * Modelo para la tabla de referencia WHO: Height for Age.
 * 
 * Contiene los parámetros LMS y desviaciones estándar precalculadas
 * para calcular z-scores de talla según edad y género.
 * Rango: 24-60 meses (2-5 años) - Medición de pie
 */
final class WhoHeightForAge extends ParentModel
{
    /**
     * Nombre de la tabla.
     */
