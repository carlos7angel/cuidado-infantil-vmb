...
/**
 * Modelo para la tabla de referencia WHO: Weight for Age.
 * 
 * Contiene los parámetros LMS y desviaciones estándar precalculadas
 * para calcular z-scores de peso según edad y género.
 */
final class WhoWeightForAge extends ParentModel
{
    /**
     * Nombre de la tabla.
     */
