...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('who_height_for_age', function (Blueprint $table) {
            $table->id();
            $table->unsignedSmallInteger('month')->comment('Edad en meses (24-60 meses, 2-5 años) - Medición de pie');
            ...
            $table->unique(['month', 'gender'], 'who_height_age_month_gender_unique');
        });
    }
