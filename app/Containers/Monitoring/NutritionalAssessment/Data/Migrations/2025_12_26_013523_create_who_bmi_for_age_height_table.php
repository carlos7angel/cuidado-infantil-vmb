...
return new class extends Migration
{
    ...
    {
        Schema::create('who_bmi_for_age_height', function (Blueprint $table) {
            $table->id();
            $table->unsignedSmallInteger('month')->comment('Edad en meses (24-60 meses, 2-5 años) - IMC usando talla (medición de pie)');
            ...
            $table->unique(['month', 'gender'], 'who_bmi_age_height_month_gender_unique');
        });
    }
    ...
    {
        Schema::dropIfExists('who_bmi_for_age_height');
    }
};
