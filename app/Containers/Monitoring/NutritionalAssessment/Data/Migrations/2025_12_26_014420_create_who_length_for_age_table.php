...
return new class extends Migration
{
    ...
    {
        Schema::create('who_length_for_age', function (Blueprint $table) {
            $table->id();
            $table->unsignedSmallInteger('month')->comment('Edad en meses (0-24 meses, 0-2 años) - Medición acostado');
            ...
            $table->unique(['month', 'gender'], 'who_length_age_month_gender_unique');
        });
    }
    ...
    {
        Schema::dropIfExists('who_length_for_age');
    }
};
