...
return new class extends Migration
{
    ...
    {
        Schema::create('who_weight_for_length', function (Blueprint $table) {
            $table->id();
            $table->decimal('length', 5, 2)->comment('Longitud en cm (0-2 años) - Medición acostado');
            ...
            $table->index(['length', 'gender']);
            $table->unique(['length', 'gender'], 'who_weight_length_length_gender_unique');
        });
    }
    ...
    {
        Schema::dropIfExists('who_weight_for_length');
    }
};
