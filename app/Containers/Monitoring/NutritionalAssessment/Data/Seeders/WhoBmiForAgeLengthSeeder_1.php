...
final class WhoBmiForAgeLengthSeeder_1 extends ParentSeeder
{
    public function run(): void
    {
        // Verificar si la tabla ya tiene datos
        $exists = DB::table('who_bmi_for_age_length')->exists();
        ...
        // Ruta al archivo SQL
        $sqlFile = database_path('SQL/who_bmi_for_age_length.sql');
