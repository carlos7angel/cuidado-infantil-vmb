...
final class WhoWeightForLengthSeeder_1 extends ParentSeeder
{
    public function run(): void
    {
        // Verificar si la tabla ya tiene datos
        $exists = DB::table('who_weight_for_length')->exists();
        ...
        // Ruta al archivo SQL
        $sqlFile = database_path('SQL/who_weight_for_length.sql');
