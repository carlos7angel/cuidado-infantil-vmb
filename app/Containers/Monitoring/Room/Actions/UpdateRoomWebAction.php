...
use App\Containers\Monitoring\Room\Tasks\UpdateRoomTask;
use App\Ship\Parents\Actions\Action as ParentAction;
use Illuminate\Http\Request;

final class UpdateRoomWebAction extends ParentAction
{
    ...
    public function run(Request $request, int $id): Room
    {
