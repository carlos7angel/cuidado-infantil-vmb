...
@section('breadcrumbs')
    <ul class="breadcrumb breadcrumb-separatorless fw-semibold">
        ...
        <li class="breadcrumb-item text-white fw-bold lh-1">
            <a class="text-white text-hover-secondary">Centros de Cuidado Infantil</a>
        </li>
    </ul>
@endsection
...
@section('headline')
    <div class="page-title d-flex align-items-center me-3">
        <h1 class="page-heading d-flex text-white fw-bolder fs-1 flex-column justify-content-center my-0">
            ...
            <span class="page-desc text-white opacity-50 fs-6 fw-bold pt-3">Gestión de Centros</span>
        </h1>
    </div>
    ...
    <div id="kt_app_content" class="app-content">
            ...
            <div class="card-body p-0">
                ...
                <div class="collapse" id="kt_advanced_search_form">
                    ...
                    <div class="row g-8 mb-5">
                        ...
                        <div class="col-lg-4">
                            <label class="fs-6 form-label fw-bold text-gray-900">Departamento (Estado)</label>
                            <select class="form-select form-select-sm form-select-solid datatable-input" data-col-index="2" name="kt_search_state">
                        ...
                        <div class="col-lg-4">
                            <label class="fs-6 form-label fw-bold text-gray-900">Municipio</label>
                            <input type="text" class="form-control form-control-sm form-control-solid-x datatable-input" data-col-index="3" name="kt_search_municipality" />
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="d-flex flex-wrap flex-stack pb-7">
            <div class="d-flex flex-wrap align-items-center my-1">
                <h3 class="fw-bold me-5 my-1">Todos los Centros
                    <span class="text-gray-500 fs-6 ms-2"></span>
                </h3>
            </div>
            <div class="d-flex flex-wrap my-1">
                <a href="{{ route('admin.childcare_center.form_create') }}" class="btn btn-primary"><i class="ki-outline ki-file-added fs-3 me-1"></i>Nuevo Registro</a>
            </div>
        </div>

        <div class="card card-flush">
            <div class="card-body">
                <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_childcare_centers"
                       data-url="{{ route('admin.childcare_center.list_json_dt') }}" aria-describedby="table">
                    <thead>
                    <tr class="text-start text-gray-500 fw-bold fs-7 text-uppercase gs-0">
                        ...
                        <th class="text-center min-w-150px" name="municipality">Municipio</th>
                        <th class="text-center min-w-150px" name="date_founded">Fecha de Fundación</th>
...
@section('scripts')
    ...
    <script src="{{ asset('themes/admin/js/custom/childcare_center/list.js') }}"></script>
@endsection