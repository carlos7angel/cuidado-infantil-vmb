...
var KTRoomsList = function () {

    var table = document.getElementById('kt_table_rooms');
    var datatable;
        ...
        datatable = $(table).DataTable({
            ...
            columnDefs: [
                ...
                },
                {
                    ...
                    render: function (data, type, full, meta) {
                        let toEditUrl = "/admin/grupos-salas/editar/" + full.id;
                ...
                },
                {
                    ...
                    className: 'text-center pe-0',
                    render: function (data, type, full, meta) {
                        var badgeClass = data === 'Activo' ? 'badge-light-success' : 'badge-light-danger';
                ...
                },
                {
                    ...
                    className: 'text-center pe-0',
                    render: function (data, type, full, meta) {
                        return `<span class="text-gray-900 fw-semibold d-block fs-7">${data || '-'}</span>`;
                    },
                },
                {
                    targets: 5,
                ...
                },
                {
                    ...
                    className: 'text-end',
                    render: function (data, type, full, meta) {
                        var toEditUrl = "/admin/grupos-salas/editar/" + full.id;
