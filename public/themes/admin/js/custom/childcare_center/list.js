...
var KTChildcareCentersList = function () {

    var table = document.getElementById('kt_table_childcare_centers');
    var datatable;
    ...
    var initTable = function () {
        ...
        datatable = $(table).DataTable({
            ...
            columns: [
                ...
                {data: 'date_founded', name: "date_founded"},
            ...
            columnDefs: [
                ...
                },
                {
                    ...
                    render: function (data, type, full, meta) {
                        let toEditUrl = "/admin/centros/editar/" + full.id;
                ...
                },
                {
                    ...
                    className: 'text-end',
                    render: function (data, type, full, meta) {
                        var toEditUrl = "/admin/centros/editar/" + full.id;
